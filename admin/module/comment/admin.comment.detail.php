...
if($cn == NULL)
   ...
   $sql = "select * from Comment,Product where Product.PRO_ID = Comment.PRO_ID and COMMENT_ID = ".$pID;
                    ...
                    <table class="table">                        
                        <tbody>
                          <tr>
                            ...
                            <?php echo '<td>'.$row["PRO_NAME"].'</td>';?>
                          </tr>
                          <tr>
                            <td>Commentator Name</td>
                            <?php echo '<td>'.$row["COMMENT_NAME"].'</td>';?>
                          </tr>
                          <tr>
                            <td>Member</td>
                            <td><?php 
                          ...
                          <tr>
                            <td>Time</td>
                            <?php echo '<td>'.$row["COMMENT_DATE"].'</td>';?>
                          </tr>
                          <tr>
                            <td>Content</td>
                            <?php echo '<td>'.$row["COMMENT_CONTENT"].'</td>';?>
                          </tr>
                        </tbody>
                    </table>
