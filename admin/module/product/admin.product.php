                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-2 col-sm-3" style="background-color: #263544;">
                            <ul>
                                <li  style="font-size:30px; padding: 20px 0;" class="item-dashboard"><a  href="../../index.html" class="reset-underline">Introduction</a></li>
                                ...
                                <li style="font-size:25px; padding-bottom: 20px;" class="item-dashboard"><a href="../../module/product/admin.product.php" class="reset-underline"><i
                                ...
                                <li style="font-size:25px; padding-bottom: 20px;" class="item-dashboard"><a href="../../module/news/admin.news.html" class="reset-underline"><i class="far fa-bell"></i>News</a></li>
